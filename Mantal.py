...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mMANTAL JANU

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+92 304 1367396

\x1b[93;1m FACEBOOK       \x1b[92;1m=>      \x1b[93;1mMANTAL JANU
...
def menu(): #Janu
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/100079044031847 ")

		exit()

	else:

		os.system("https://www.facebook.com/100079044031847 ")
...
def crack2(idf,pwv):
	...
	print('\r%s [MANTAL] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
